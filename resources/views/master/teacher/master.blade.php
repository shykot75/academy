...
<head>
    ...
    <!-- Summer Note -->
    <link type="text/css" href="{{asset('/')}}assets/css/summernote-bs4.min.css" rel="stylesheet">
            ...
            <div class="navbar navbar-expand navbar-dark-dodger-blue bg-transparent will-fade-background"  data-primary>
                ...
                <div class="nav navbar-nav flex-nowrap d-flex mr-16pt">
                    ...
                    <div class="nav-item ml-16pt dropdown dropdown-notifications dropdown-xs-down-full" data-toggle="tooltip" data-placement="bottom" >
                        ...
                        <span class="text-white font-size-16pt">{{Session::get('teacher_name')}}</span>
...
{{--                                <span class="avatar-title rounded-circle bg-primary"><i class="material-icons">account_box</i></span>--}}
                                <img src="{{asset(Session::get('teacher_image'))}}" class= "avatar-title rounded-circle">
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" data-toggle="collapse" href="#admin_module">
                        ...
                        <ul class="sidebar-submenu collapse sm-indent" id="admin_module">
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{route('add-subject')}}">
                                    <span class="sidebar-menu-text">ADD Subject</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="{{route('manage-subject')}}">
                                    <span class="sidebar-menu-text">Manage Subject</span>
                                </a>
                            </li>
                    ...
                    <ul class="sidebar-submenu collapse sm-indent" id="teacher_module">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="">
                                <span class="sidebar-menu-text">Approved Course</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{">
                                <span class="sidebar-menu-text">Denied Course</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="">
