            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body p-3">
                        <h4 class="card-title mx-3 my-2 text-info font-size-20pt">ADD Administrator </h4>
                        <p class="text-center text-success font-size-20pt">{{Session::get('message')}}</p>
                        <form action="{{route('new-administrator')}}" method="POST" enctype="multipart/form-data">
                            @csrf
