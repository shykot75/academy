...
@section('title')
    Academy | A Digital Learning Platdorm
@endsection
...
@section('body')
                                ...
                                <div class="card js-overlay card-sm overlay--primary-dodger-blue stack stack--1 card-group-row__card" data-toggle="popover" data-trigger="click">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="fixed-student-path.html" data-toggle="tooltip" data-title="Add Favorite" data-placement="top" data-boundary="window" class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite_border</a>
        ...
        <div class="page-section border-bottom-2">
                    <div class="container page__container">
                        <div class="page-separator">
                            <div class="page-separator__text">Our Courses</div>
                        </div>
